...
export default function Nasdace({
  playerData,
  position = [0, 0, 0],
  scale = [4, 4, 4],
  rotation = [0, 180, 0],
      ...
      <Html position={[4, 1, 4]} center>
        <div className="nasdace-text">
          <div className="nasdace-text-content">
            Salut, tu dois être {playerData.name} ! On t'attendait, il faut vite
            qu'on y aille, si on part maintenant, vu l'alignement de la Terre et
            Mars on devrait arriver qu'en 228 jours
          </div>
